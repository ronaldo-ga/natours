...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF4eG9yMjAxMCIsImEiOiJjazE2dWduOHYwOHZmM2hsanVsZGg4OG9nIn0.ijqM_Uqdvgr2l-JlTmBv0w';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              document.getElementById('userPhoto').src = "img/users/".concat(res.data.data.user.photo);
              document.getElementById('profilePic').src = "img/users/".concat(res.data.data.user.photo);
            }
...
var stripe = Stripe('pk_test_DZULHKHETotbe079ltgCCcsq00cXO2aCLc');
...
var bookElem = document.getElementById('book-tour'); // DELEGATION
...
if (bookElem) {
  bookElem.addEventListener('click', function (e) {
